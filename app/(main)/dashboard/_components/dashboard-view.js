...
const DashboardView = ({ insights }) => {
  ...
  // const lastUpdateDate = format(new Date(insights.lastUpdateDated), "dd/MM/yyyy");
            ...
            <div className="h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <YAxis />
                  <Tooltip />
                  <Legend content = {(active, payload, label)=>{
                    if(active && payload && payload.length){
                      return(
                        <div className="bg-background border rounded-lg p-g shadow-md">
